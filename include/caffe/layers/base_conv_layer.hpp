...
//see http://blog.csdn.net/xizero00/article/details/51049858
namespace caffe {
...
class BaseConvolutionLayer : public Layer<Dtype> {
 ...
 private:
  ...
  int kernel_dim_; //kernel_dim_ = input channels per-group x kernel height x kernel width(一个kernel大小的图像块的维度是，输入图像的通道数乘以kernel的长度和宽度)
