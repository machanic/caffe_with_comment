...
//see http://blog.csdn.net/seven_first/article/details/47378697
//see http://blog.csdn.net/langb2014/article/details/50986678
namespace caffe {
...
void caffe_cpu_gemm<float>(const CBLAS_TRANSPOSE TransA,
    ...
    float* C) {
  int lda = (TransA == CblasNoTrans) ? K : M;  //K是A的列数，也是B的行数；M是A，C的行数
  int ldb = (TransB == CblasNoTrans) ? N : K;  //N是B的列数，也是C的列数
...
/**
see http://blog.sina.com.cn/s/blog_67b9b8d00100qm73.html
生成uniform_real分布,variate_generator为随机数生成器
**/
template <typename Dtype>
