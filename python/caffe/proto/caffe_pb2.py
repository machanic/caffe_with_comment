...
_V1LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='insanity_param', full_name='caffe.V1LayerParameter.insanity_param', index=43,
